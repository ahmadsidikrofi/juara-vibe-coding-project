...
const ButtonCopy = ({ text, onClick }) => {
  ...
  return (
    <div
      className="relative overflow-hidden flex items-center justify-center bg-muted rounded-full px-6 w-full h-12 border border-border">
      {/* Progress background */}
      <div
        className={cn(
      ...
      <div
        ...
        <span
          className="text-sm font-mono font-medium tracking-widest text-muted-foreground select-all truncate max-w-[150px]">
          {CODE}
        </span>
        <Button
          onClick={() => {
